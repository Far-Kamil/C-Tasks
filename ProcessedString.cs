...
namespace _10_task
{
    ...
    public class ProcessedString : IProcessedString, IDisposable
    {
        ...
        {
            return GetNonMatchingCharacters(str, Constans.englishLower);
        }
        ...
        public static HashSet<char> GetNonMatchingCharacters(string str, string allowedChars)
        {

...
namespace TestProjects
{
    public class Tests
    {
        ...
        {
            string original = "abc";
            string result = ProcessedString.InvertAndJoin(original);
        ...
        public void GetNonLowercaseEnglish_whenEnglishLowerAlphabet_emptyHashSet()
        {
            ...
            HashSet<char> result = ProcessedString.GetNonLowercaseEnglish(str);
        ...
        public void CountOccurences_whenEnglishLowerAlphabet_EveryCharacterIsOnlyOnce()
        {
            ...
            string str = Constans.englishLower;
            Dictionary<char, int> result = ProcessedString.CountCharacterOccurrences(str);
        ...
        {
            string str = "abcde";
            string result = ProcessedString.GetLongestVowelSubstring(str);
